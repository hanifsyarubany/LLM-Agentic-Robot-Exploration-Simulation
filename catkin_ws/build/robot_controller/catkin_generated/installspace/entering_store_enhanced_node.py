...
class EnteringStoreNode(object):
    def __init__(self):
        ...
        self.side_speed      = rospy.get_param("~side_speed", 0.25)      # m/s

        # Stage 1 rotation angles
        self.scan_angle_deg  = rospy.get_param("~scan_angle_deg", 45.0)  # for search
        self.full_angle_deg  = rospy.get_param("~full_angle_deg", 90.0)  # final face
        ...
        self.target_label = None      # e.g. "cafe", "hamburger_store"
